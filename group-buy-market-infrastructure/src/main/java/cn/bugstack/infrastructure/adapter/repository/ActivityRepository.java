...
public class ActivityRepository implements IActivityRepository {
    ...
    @Override
    public ActivityGoodsAggerate queryGroupBuyActivityDiscountAggerate(Long activityId) {
        ...
        Long discountId = groupBuyActivity.getDiscountId();

        GroupBuyDiscount groupBuyDiscount = groupBuyDiscountDao.queryGroupBuyActivityDiscountByDiscountId(String.valueOf(discountId));
    ...
    @Override
    public GoodsEntity querySkuByGoodsId(String goodsId) {
