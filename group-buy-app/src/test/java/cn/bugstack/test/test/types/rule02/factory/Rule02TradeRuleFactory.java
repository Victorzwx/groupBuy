package cn.bugstack.test.test.types.rule02.factory;


import cn.bugstack.test.test.types.rule02.logic.RuleLogic201;
import cn.bugstack.test.test.types.rule02.logic.RuleLogic202;
import cn.bugstack.test.test.types.rule02.logic.XxxResponse;
