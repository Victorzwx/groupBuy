...
public class MarketTradeController implements IMarketTradeService {
    ...
    public Response<LockMarketPayOrderResponseDTO> lockMarketPayOrder(@RequestBody LockMarketPayOrderRequestDTO requestDTO) {
        try {
            ...
            if (StringUtils.isBlank(userId) || StringUtils.isBlank(source) || StringUtils.isBlank(channel) || StringUtils.isBlank(goodsId) || StringUtils.isBlank(outTradeNo) || StringUtils.isBlank(notifyUrl)) {
            ...
            // 人群限定
            if (!activityEntity.getIsVisible() || !activityEntity.getIsEnable()) {
                return Response.<LockMarketPayOrderResponseDTO>builder()
