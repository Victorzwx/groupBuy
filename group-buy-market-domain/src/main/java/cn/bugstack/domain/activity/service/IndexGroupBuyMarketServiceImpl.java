...
public class IndexGroupBuyMarketServiceImpl implements IIndexGroupBuyMarketService {
    ...
    @Override
    public TrialResponseAggerate indexMarketTrial(TrialRequestEntity trialRequestEntity) throws Exception {
        // 获取执行策略
        StrategyHandler<TrialRequestEntity, DefaultActivityStrategyFactory.DynamicContext, TrialResponseAggerate> strategyHandler = defaultActivityStrategyFactory.strategyHandler();
        // 受理试算操作
        return strategyHandler.apply(trialRequestEntity, new DefaultActivityStrategyFactory.DynamicContext());
    }
