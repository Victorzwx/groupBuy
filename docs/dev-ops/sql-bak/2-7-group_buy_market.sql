...
CREATE TABLE `group_buy_activity` (
                                      ...
                                      `tag_scope` VARCHAR(4) DEFAULT NULL COMMENT '人群标签规则范围（多选；11，限制可见，限制参与；10，限制可见；01，限制参与；00，无限制）',
                                      `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                      `update_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                      PRIMARY KEY (`id`),
...
VALUES
    ...
    (3,'25120211','每满减优惠100-10元','每满减优惠100-10元',0,'MMJ','100,10',NULL,'2024-12-07 10:20:18','2024-12-22 12:11:35'),
    (6,'25120200','无活动','无活动',0,'WHD','0',NULL,'2024-12-07 10:20:21','2024-12-22 12:11:45');
